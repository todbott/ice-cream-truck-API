// -- NOTE ---
// This Spring Boot project originally served as the backend
// for an e-commerce smartphone app, and required admin
// login to do things like upload new items to the shop,
// check the contents of users' carts, etc.  This file was
// used for that function, but it's not necessary for the ice cream truck
// API, so I've commented it out.
